 ...
 * helper methods.
 */
public class TrailerAPI_Service extends IntentService {
    ...
    public TrailerAPI_Service() {
        super("TrailerAPI_Service");
    }
    ...
    public static void startActionFoo(Context context, String param1, String param2) {
        Intent intent = new Intent(context, TrailerAPI_Service.class);
        ...
        if (intent != null) {
            ...
            try {
                ...
                try {
                    ...
                    TrailerParser parser = new TrailerParser(stringBuilder.toString());
                    ArrayList<MovieAdded> trailers = parser.getData();
                    Intent resultsIntent = new Intent("movies_trailers");
                    Bundle dataBundle = new Bundle();
                    dataBundle.putString("data", new Gson().toJson(trailers));
